...
using SmartLibrary.Open.GrpcClientTest.Service;
using SmartLibraryUser;
using System;
using System.IO;
using System.Threading.Tasks;
using SmartLibrarySearch;
    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                var userGrpcClientFactory = serviceProvider.GetService<SmartGrpcClientFactory<SearchBoxTitleItemGrpcService.SearchBoxTitleItemGrpcServiceClient>>();
                ...
                var response = await userGrpcClient.GetAllAvailableTitleItemAsync(new  SearchBoxTitleItemRequest(), headers);
