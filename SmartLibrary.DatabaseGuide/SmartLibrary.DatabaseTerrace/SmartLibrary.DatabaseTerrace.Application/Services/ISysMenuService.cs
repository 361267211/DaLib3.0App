...
namespace SmartLibrary.DatabaseTerrace.Application.Services
{
    public interface ISysMenuService
    {
        ...
        Task<List<SysMenuPermissionDto>> GetMGRApiPermissionList();
        Task<List<SysMenuPermissionDto>> GetOperatorApiPermissionList();
        Task<List<SysMenuPermissionDto>> GetVisitorsApiPermissionList();
