...
namespace SmartLibrary.DatabaseTerrace.Database.Migrations.Migrations
{
    ...
    partial class DatabaseTerraceDbContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("SmartLibrary.DatabaseTerrace.EntityFramework.Core.Entitys.DatabaseColumnRule", b =>
                {
                    ...
                    b.ToTable("DatabaseColumnRule");
                });

            modelBuilder.Entity("SmartLibrary.DatabaseTerrace.EntityFramework.Core.Entitys.DatabaseDefaultTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DatabaseDefaultTemplate");
                });
            ...
            modelBuilder.Entity("SmartLibrary.DatabaseTerrace.EntityFramework.Core.Entitys.DatabaseTerrace", b =>
                {
                    ...
                    b.Property<int>("InformationEditor")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ResourceProvider")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.Property<int>("ResourceStatisticsEditor")
                        .HasColumnType("integer");

                    b.Property<string>("ResourceStatisticsText")
                        .HasColumnType("text");
                    ...
                    b.Property<int>("UseGuideEditor")
                        .HasColumnType("integer");

                    b.Property<string>("UseGuideText")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("SmartLibrary.DatabaseTerrace.EntityFramework.Core.Entitys.DatabaseTerraceSettings", b =>
                {
                    ...
                    b.Property<int>("DefaultSortRule")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DatabaseTerraceSettings");
                });
