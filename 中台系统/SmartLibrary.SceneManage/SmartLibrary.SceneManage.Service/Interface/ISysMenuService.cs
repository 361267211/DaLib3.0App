...
namespace SmartLibrary.SceneManage.Services
{
    public interface ISysMenuService
    {
        ...
        /// </summary>
        /// <returns></returns>
        Task<List<PermissionNode>> GetAllPermissionTree();
        /// <summary>
        /// 获取当前登陆用户的所有权限列表
        /// </summary>
        ...
        Task<PermissionNode> GetUserPermissionTree(Guid guid);
        ...
        Task<List<PermissionNode>> GetMGRPermissionTree();
        Task<List<PermissionNode>> GetOperatorPermissionTree();
        Task<List<PermissionNode>> GetVisitorsPermissionTree();
    }
}
