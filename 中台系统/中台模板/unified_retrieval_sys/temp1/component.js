...
<div id="unified_retrieval_sys_temp1_Search" v-if="searchBoxConfigure">
  ...
  <div class="head">
    <div class="search-content">
      ...
      <div class="search-btns-wrap">
        <div class="head-font search-btn cursor" @click="basicSearch">统一检索</div>
        ...
        if (list[i].getAttribute('class').indexOf('jl_vip_zt_vray') < 0) {
            ...
            new Vue({
                ...
                mounted() {
                    ...
                    if (unified_retrieval_sys_temp1_set_list) {
                        for (var i = 0; i < unified_retrieval_sys_temp1_set_list.length; i++) {
                            var columnid = unified_retrieval_sys_temp1_set_list[i].id;
...
setTimeout(() => { unified_retrieval_sys_temp1() }, 500)