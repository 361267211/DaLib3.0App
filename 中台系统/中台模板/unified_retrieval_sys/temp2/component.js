function unified_retrieval_sys_temp2() {
        ...
        <template v-for="(item, index) in dynamicExpressionFormModels">
          <div class="block-content-middle-item" :key="index">
            ...
            <div class="cursor" v-if=" index == dynamicExpressionFormModels.length - 1 && dynamicExpressionFormModels.length < 5 " @click="addDynamicExpression">
              <img src="http://192.168.21.71:9000/image/jiajian.png" style="width: 30px" />
            </div>
            <div class="cursor" v-else style="visibility: hidden;">
              <img src="http://192.168.21.71:9000/image/jiajian.png" style="width: 30px" />
            </div>
            <div class="cursor" v-if="index != 0" @click="removeDynamicExpresion(item)">
              <img src="http://192.168.21.71:9000/image/jiajian1.png" style="width: 30px" />
            </div>
            <div class="cursor" v-else style="visibility: hidden;">
              <img src="http://192.168.21.71:9000/image/jiajian1.png" style="width: 30px" />
            </div>
...
<div v-if="block_s" class="bolck-box">
  <div class="ex-body">
    ...
    */
    ...
    var list = document.getElementsByClassName('unified_retrieval_sys_temp2');
    for (var i = 0; i < list.length; i++) {
        if (list[i].getAttribute('class').indexOf('jl_vip_zt_vray') < 0) {
            list[i].setAttribute('class', 'unified_retrieval_sys_temp2 jl_vip_zt_vray jl_vip_zt_warp');
...
setTimeout(() => { unified_retrieval_sys_temp2() }, 500)