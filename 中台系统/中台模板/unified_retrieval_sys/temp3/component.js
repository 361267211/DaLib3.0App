function unified_retrieval_sys_temp3() {
    var unified_retrieval_sys_temp3_temmplate = `
<div id="unified_retrieval_sys_temp3_Search" v-if="searchBoxConfigure" :style="{background: 'url('+fileUrl+'/public/image/top-bg.png) no-repeat center'}">
...
<div class="search">
  ...
  <div class="head">
    <div class="search-content">
      <div class="head-odiv">
        <input type="text" placeholder="搜索相关资源" v-model="basicInputKeyWord" @blur="inputBlur" @focus="emptySearch"  @keyup.enter="basicSearch" ref="mainInput" />
      </div>
      <div class="search-btns-wrap">
        <div class="head-font search-btn cursor" @click="basicSearch">弘深搜索</div>
  ...
  <div class="body">
    <div id="advancedRetrieval">
      <div class="block-content-top">
        ...
        <div class="cursor" style="padding-bottom: 23px" @click="tabSwitch()">表达式检索 </div>
      </div>
  ...
  <div class="ex-body">
    <div class="ex-content">
      <div class="ex-content-top">
        <div style="padding-bottom: 23px" class="cursor" @click="tabSwitch_s()">
          高级检索
        </div>
    ...
    */
    ...
    var list = document.getElementsByClassName('unified_retrieval_sys_temp3');
    for (var i = 0; i < list.length; i++) {
        if (list[i].getAttribute('class').indexOf('jl_vip_zt_vray') < 0) {
            list[i].setAttribute('class', 'unified_retrieval_sys_temp3 jl_vip_zt_vray jl_vip_zt_warp');
            var unified_retrieval_sys_temp3_set_list = null;
            if (list[i].dataset && list[i].dataset.set) {
                unified_retrieval_sys_temp3_set_list = JSON.parse(list[i].dataset.set.replace(/'/g, '"'));
            }
            new Vue({
                el: '#' + list[i].lastChild.id,
                template: unified_retrieval_sys_temp3_temmplate,
                ...
                mounted() {
                    ...
                    if (unified_retrieval_sys_temp3_set_list) {
                        for (var i = 0; i < unified_retrieval_sys_temp3_set_list.length; i++) {
                            var columnid = unified_retrieval_sys_temp3_set_list[i].id;
                ...
                methods: {
                    ...
                    /**基本检索 */
                    basicSearch() {
                        if (!this.basicInputKeyWord) {alert('请输入检索条件'); return;}
...
setTimeout(() => { unified_retrieval_sys_temp3() }, 500)