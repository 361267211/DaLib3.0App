...
namespace SmartLibrary.Open.Services.AppManagement.Redis
{
    public interface IRedisService
    {
        ...
        void Push(string stream, NameValueEntry[] message);
        /// <summary>
        /// 创建主体消费组
        /// </summary>
        /// <param name="stream"></param>
        ...
        /// <returns></returns>
        bool StreamCreateConsumerGroup(string stream, string consumerGroup);
        /// <summary>
        /// 消息收到确认
        /// </summary>
        /// <param name="stream"></param>
        ...
        /// <returns></returns>
        long Ack(string stream, string consumerGroup, string messageId);
        /// <summary>
        /// 轮训获取待确认消息
        /// </summary>
