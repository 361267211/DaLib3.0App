...
using SmartLibrary.DataCenter.Application;
using SmartLibrary.DataCenter.Application.GrpcService.Service;
using SmartLibrary.DataCenter.Common.Dtos;
using SmartLibrary.DataCenter.EntityFramework.Core.DbContexts;
using SmartLibrary.DataCenter.Web.Jwt;
using System;
using System.IO;
...
namespace SmartLibrary.DataCenter.Web
{
    public class Startup
    {
        ...
        {
            Console.WriteLine("这是最新版本");

         var apollo=   Configuration.GetSection("Apollo:MetaServer").Value;
         var sqlcon=   Configuration.GetSection("SqlServer").Value;
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapGrpcService<DomainService>();
                endpoints.MapGrpcService<DatabaseCollectKindService>();
                endpoints.MapGrpcService<ProviderResourceService>();
                endpoints.MapGrpcService<SourceTypeService>();
