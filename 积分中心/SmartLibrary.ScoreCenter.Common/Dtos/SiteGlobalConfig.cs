...
namespace SmartLibrary.ScoreCenter.Common.Dtos
{
    public static class SiteGlobalConfig
    {
        ...
        public static string HostUrl { get; set; }//站点地址
        ...
        public static string SugarDbType { get; set; } = "PostgreSQL";
        public static string Owner { get; set; } = "public";
        public static string AppCode { get; set; } = "scorecenter";
        public static string AppName { get; set; } = "积分中心";
        public static string DtmUrl { get; set; } = "http://192.168.21.46:36789";
    }
