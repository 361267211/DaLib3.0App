...
namespace SmartLibrary.Identity.Common.Dtos
{
    public static class SiteGlobalConfig
    {
        ...
        public static string TokenAddress { get; set; }
        public static string CasUrl { get; set; }
        public static string AppCode { get; set; } = "useridentify";
        public static string AppName { get; set; } = "用户认证";
    }
